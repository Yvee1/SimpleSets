...
class ShapeHighlight(val shape: Shape, override val contour: ShapeContour, override val allPoints: List<Point>, expandRadius: Double, override val type: Int = allPoints[0].type)
    : Highlight() {
