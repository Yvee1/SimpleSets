...
external interface BendSettingsPanelProps: Props {
    var ptSize: Double
...
val BendSettingsPanel = FC<BendSettingsPanelProps> { props ->
                ...
                div {
                    ...
                    svg {
                        val (svg, bbox) = bendPreview(
                            bendDistance, maxTurningAngle, maxBendAngle, props.ptSize,
...
fun bendPreview(maxDistance: Double, maxTurningAngle: Double, maxTotalAngle: Double,
                pointSize: Double, pointStrokeWeight: Double, lineStrokeWeight: Double,
                expandRadius: Double, color: String): Pair<String, Rectangle> {
    val pts = extremeBend(maxDistance, maxTurningAngle, maxTotalAngle)
