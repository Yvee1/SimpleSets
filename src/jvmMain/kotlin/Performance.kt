...
fun main() {
    ...
    val expandRadius = 6.0
    val instance = PartitionInstance(points, 18.634, 50.64, true, 107.32, 54.783)
//    val instance = ProblemInstance(points, 6.0, 0.634, 0.64, true, 107.32, 54.783)
    ...
    val islands = patterns.map { it.toHighlight(expandRadius) }
    ...
    val voronoiCells = approximateVoronoiDiagram(patterns.map { it.original() }, expandRadius)
